...
main(){
	...
	switch(escolha){
		...
		case 3:
			system("cls");
			puts("Voce escolheu multiplicação");
			puts("Deseja voltar?\n 1 -> Para não\n 2 -> Para sim");
			scanf("%d", &voltar);
		...
		case 5:
			...
			scanf("%d", &voltar);
				...
				break;
					...
					puts("Digite o segundo valor");
					scanf("%f",&num2);
					printf("O resultado é: %2.f",multiplicacao(num1,num2));
					break;
			}
					else{
